			...
			<div id="metabox_basic_settings" class="postbox cff-add-on-settings <?php print esc_attr(__CLASS__); ?>" >
				...
				<div class="inside">
					<table cellspacing="3px" style="width:100%;">
						...
						?>
						<tr>
							<td><?php _e( 'Property ID', 'calculated-fields-form' ); ?>: <input type="text" name="cpcff_analytics_property" value="<?php print $property; ?>" style="width:100%;" placeholder="UA-XXXXX-Y" /></td>
						</tr>
						<tr>
							<td>
