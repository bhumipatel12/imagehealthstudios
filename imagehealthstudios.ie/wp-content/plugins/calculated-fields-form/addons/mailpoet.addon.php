					...
					<table cellspacing="0" style="width:100%;">
									...
									if( ($email = trim($email)) !== '' )
										print '
											<tr>
												...
												<td><input type="text" name="cpcff_mailpoet_emails[]" value="'.esc_attr( $email ).'" placeholder="fieldname#" /> <input type="button" value="[ X ]" onclick="cpcff_mailpoet_removeEmail( this );" /></td>
											</tr>
										';
								}
							}
						...
						<tr>
							...
							<td>
								...
								<input type="button" value="[ X ]" onclick="cpcff_mailpoet_removeEmail( this );" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<input type="button" value="<?php esc_attr_e('Add new Email', 'calculated-fields-form');?>" onclick="cpcff_mailpoet_addEmail( this );" />
							</td>
						</tr>
						<?php
				...
				<script>
					...
					function cpcff_mailpoet_addEmail( e )
					{
						try
						{
							...
							e.closest( 'tr' )
							 .before(
								'<tr><td style="white-space:nowrap;width:200px;"><?php print esc_js(_e('Email field', 'calculated-fields-form')); ?>:</td><td><input name="cpcff_mailpoet_emails[]" value="" placeholder="fieldname#" /> <input type="button" value="[ X ]" onclick="cpcff_mailpoet_removeEmail( this );" /></td></tr>'
							 );
						}
						catch( err ){}
					}
