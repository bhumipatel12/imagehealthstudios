...
{return(typeof v=='number')?isFinite(v):(typeof v!='undefined');}};;(function(root){var lib={},defaultUnitSystem='km',defaultTravelMode='DRIVING',defaultAvoidHighways=false,defaultAvoidTolls=false,defaultAvoidFerries=false,latlngArr={},distanceArr=[],geocodingObj={},travelTimeArr=[],callbacks=[],cff_timeout_id={};function _runCallbacks()
...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['connector']['prefix'],CF_CONNECTOR);}};;(function(root){var version='3.7.1',lib={},_$,_loading=false,_queue=[],colors_json={"red":["#ffa8a8","#ff8787","#ff6b6b","#fa5252"],"blue":["#74c0fc","#4dabf7","#339af0","#228be6"],"yellow":["#ffe066","#ffd43b","#fcc419","#fab005"],"green":["#8ce99a","#69db7c","#51cf66","#40c057"],"pink":["#faa2c1","#f783ac","#f06595","#e64980"],"cyan":["#66d9e8","#3bc9db","#22b8cf","#15aabf"],"orange":["#ffc078","#ffa94d","#ff922b","#fd7e14"],"lime":["#c0eb75","#a9e34b","#94d82d","#82c91e"],"grape":["#e599f7","#da77f2","#cc5de8","#be4bdb"],"indigo":["#91a7ff","#748ffc","#5c7cfa","#4c6ef5"],"teal":["#63e6be","#38d9a9","#20c997","#12b886"],"violet":["#b197fc","#9775fa","#845ef7","#7950f2"]},_initialized=false;function pickColor(i)
...
_chart=new Chart(_canvas,obj);_canvas.data('chart-obj',_chart);}};lib.cff_chart_version='0.1';lib.cffchart=lib.CFFCHART=function(canvasId,args,field)
...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['file']['prefix'],CF_FILE);}};$.fbuilder['version']='10.1.113';$.fbuilder['controls']=$.fbuilder['controls']||{};$.fbuilder['forms']=$.fbuilder['forms']||{};$.fbuilder['htmlEncode']=window['cff_esc_attr']=function(value)
...
{return this.records;}
return[];},addRecord:function(record)
{try
...
{$.fn.dataTableExt.errMode='ignore';$('.'+me.name+' .dfield table').DataTable(settings);}catch(err){$('.'+me.name+' .dfield').html('');console.log(err);}}});}});$.fbuilder.controls['fdateds']=function(){};$.extend($.fbuilder.controls['fdateds'].prototype,$.fbuilder.controls['fdate'].prototype,$.fbuilder.controls['datasource'].prototype,{ftype:"fdateds",first_time:true,excludeColumn:"",includeColumn:"",precedenceColumn:"exclude",invalidDatesDS:[],validDatesDS:[],show:function()
