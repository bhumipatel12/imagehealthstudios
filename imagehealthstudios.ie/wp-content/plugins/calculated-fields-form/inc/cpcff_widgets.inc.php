...
if(!class_exists('CPCFF_DASHBOART_WIDGET'))
{
	...
	class CPCFF_DASHBOART_WIDGET
	{
		...
		public function dashboard_widget()
		{
			...
			$query = "SELECT ftable.form_name, ptable.* FROM ".$wpdb->prefix.CP_CALCULATEDFIELDSF_FORMS_TABLE." as ftable, ".CP_CALCULATEDFIELDSF_POSTS_TABLE_NAME." as ptable WHERE ptable.formid=ftable.id AND ptable.time > CURDATE() - INTERVAL 7 DAY ORDER BY ptable.time DESC;";
