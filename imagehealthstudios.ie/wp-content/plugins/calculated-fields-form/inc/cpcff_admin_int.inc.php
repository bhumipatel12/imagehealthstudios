...
<div id="metabox_submit_thank" class="postbox" >
 ...
 <div id="metabox_payment_settings" class="postbox">
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td>
           ...
           <input type="button" name="dex_dc_subccode" id="dex_dc_subccode" value="<?php esc_attr_e( 'Add', 'calculated-fields-form' ); ?>" class="button-secondary" />
           <br />
 ...
 <div id="metabox_paypal_integration" class="postbox">
 ...
 <div id="metabox_notification_email" class="postbox" >
 ...
 <div id="metabox_email_copy_to_user" class="postbox" >
 ...
 <div id="metabox_captcha_settings" class="postbox" >
...
<div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
   ...
   <?php print '<a href="javascript:cp_calculatedfieldsf_insertForm();" title="'.esc_attr__( 'Insert Calculated Fields Form', 'calculated-fields-form' ).'"><img hspace="5" src="'.plugins_url('/images/cp_form.gif', CP_CALCULATEDFIELDSF_MAIN_FILE_PATH).'" alt="'.esc_attr__( 'Insert Calculated Fields Form', 'calculated-fields-form' ).'" /></a>';    ?>
