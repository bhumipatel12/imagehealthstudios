...
class Elementor_CFFR_Widget extends Widget_Shortcode
{
	public function get_name()
	{
		return 'calculated-fields-form-result';
	} // End get_name
	...
	protected function register_controls()
	{
		$this->start_controls_section(
			'section_shortcode',
			array(
				'label' => __( 'Result Shortcode', 'calculated-fields-form' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => '<a href="https://cff.dwbooster.com/documentation#thanks-page" target="_blank">'.__( 'I need help [+]', 'calculated-fields-form' ).'</a>'
			)
		);
	...
	protected function render()
	{
		...
		add_shortcode( 'CP_CALCULATED_FIELDS_RESULT', array($cff_main,'form_result_shortcode') );
		parent::render();
	} // End render
} // End ClassElementor_CFFR_Widget

class Elementor_CFFRL_Widget extends Widget_Shortcode
{
	public function get_name()
	{
		return 'calculated-fields-form-submissions-list';
	} // End get_name

	public function get_title()
	{
		return 'Submissions List Shortcode';
	} // End get_title
	...
	protected function register_controls()
	{
		$this->start_controls_section(
			'section_shortcode',
			array(
				'label' => __( 'List Shortcode', 'calculated-fields-form' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => '<a href="https://cff.dwbooster.com/documentation#events-list" target="_blank">'.__( 'I need help [+]', 'calculated-fields-form' ).'</a>'
			)
		);
	...
	{
		$cff_main = \CPCFF_MAIN::instance();
		add_shortcode( 'CP_CALCULATED_FIELDS_RESULT_LIST', array($cff_main,'form_result_list_shortcode') );
		parent::render();
	} // End render

} // End ClassElementor_CFFRL_Widget
...
Plugin::instance()->widgets_manager->register_widget_type( new Elementor_CFFR_Widget );
Plugin::instance()->widgets_manager->register_widget_type( new Elementor_CFFRL_Widget );
